...
- **Сорок восемь локаций** в шести регионах. **Ольховый лоскут:** Ольховка,
  лес, Барсучья пещера, Развалины заставы, Святилище Нулевой точки и скрытый
  Схрон Ордена. **Шов:** Козья тропа, Стеклянное поле, Рынок Шва, Мельница на
...
- **Три развязки.** В Развязке лежит лист с тремя исходами: дотянуть сеть
  ...
  что-то ломает.
- **Пятьдесят один квест**, из них восемнадцать **тайных**: их никто не выдаёт,
...
- **Мир и его история.** Всё связано одной идеей — Стяжением, — и лор не
  выдаётся лекциями, а находится в 57 записках. См.
...
Мир доведён до конца: все шесть регионов лорной карты построены, и у игры
есть развязка. Из пятидесяти запланированных локаций сделано сорок восемь —
не хватает двух в Ольховом лоскуте, между стартовой деревней и Швом.
