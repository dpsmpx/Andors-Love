...
- **Четырнадцать локаций** в двух регионах. **Ольховый лоскут:** Ольховка,
  ...
  мост в никуда. Граф переходов двусторонний и проверяется тестом.
- **Девятнадцать квестов**, из них пять **тайных**: их никто не выдаёт, они
...
- **Мир и его история.** Всё связано одной идеей — Стяжением, — и лор не
  выдаётся лекциями, а находится в 19 записках. См.
