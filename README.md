...
- **Тридцать локаций** в четырёх регионах. **Ольховый лоскут:** Ольховка,
...
- **Тридцать шесть квестов**, из них двенадцать **тайных**: их никто не выдаёт,
...
- **Мир и его история.** Всё связано одной идеей — Стяжением, — и лор не
  выдаётся лекциями, а находится в 39 записках. См.
