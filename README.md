...
- **Сорок локаций** в пяти регионах. **Ольховый лоскут:** Ольховка,
  ...
  **Дрейф:** Дрейфующий луг, Дом на отшибе, Колодец Двух Вёдер, Роща, где не
  ...
  Лоскута, Пустая Ольховка и Тропа Возвращения.
  Граф переходов двусторонний и проверяется тестом.
- **Сорок четыре квеста**, из них шестнадцать **тайных**: их никто не выдаёт,
  ...
  Мастер или Совет; второй раз ответ не переписать.
...
- **Мир и его история.** Всё связано одной идеей — Стяжением, — и лор не
  выдаётся лекциями, а находится в 49 записках. См.
