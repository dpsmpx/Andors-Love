...
- **Двадцать локаций** в трёх регионах. **Ольховый лоскут:** Ольховка,
  ...
  Канал Мёртвой воды, Башня Счетовода и Городской архив. Граф переходов
  двусторонний и проверяется тестом.
- **Двадцать шесть квестов**, из них восемь **тайных**: их никто не выдаёт, они
  открываются событием — находкой записки, добычей предмета, входом в место,
  убийством. Есть квест **без правильного ответа**: на Хуторе Двоеданном два
  Прохора, оба настоящие, и выбор запоминается насовсем.
...
- **Мир и его история.** Всё связано одной идеей — Стяжением, — и лор не
  выдаётся лекциями, а находится в 27 записках. См.
